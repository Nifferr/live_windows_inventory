'Descricao: Inventario automatizado de maquinas e servidores
...
Next
   ...
   objtextfile.WriteLine "<table border=2 width=1000>"
    objtextfile.WriteLine "<tr><td>Login</td><td>Nome Completo</td><td>Descri�ao" & _
